    ...
    return knex('jobpost').del()
      .then(function () {
        return knex('jobpost').insert([
          ...
          { id: 11, company_id: 1, title: 'Jr Dev', level: 0, description: 'Looking for Jr Dev.', industry_id: 1, location_id: 1 },
          { id: 12, company_id: 2, title: 'Jr Dev', level: 0, description: 'Looking for Jr Dev.', industry_id: 2, location_id: 2 },
          { id: 13, company_id: 3, title: 'Jr Dev', level: 0, description: 'Looking for Jr Dev.', industry_id: 3, location_id: 3 },
          { id: 14, company_id: 4, title: 'Jr Dev', level: 0, description: 'Looking for Jr Dev.', industry_id: 4, location_id: 4 },
          { id: 15, company_id: 5, title: 'Mid Dev', level: 1, description: 'Looking for Mid Dev.', industry_id: 5, location_id: 5 },
          { id: 16, company_id: 6, title: 'Mid Dev', level: 1, description: 'Looking for Mid Dev.', industry_id: 6, location_id: 6 },
          { id: 17, company_id: 7, title: 'Mid Dev', level: 1, description: 'Looking for Mid Dev.', industry_id: 7, location_id: 7 },
          { id: 18, company_id: 8, title: 'Sr Dev', level: 2, description: 'Looking for Sr Dev.', industry_id: 8, location_id: 8 },
          { id: 19, company_id: 9, title: 'Sr Dev', level: 2, description: 'Looking for Sr Dev.', industry_id: 9, location_id: 9 },
          { id: 20, company_id: 10, title: 'Sr Dev', level: 2, description: 'Looking for Sr Dev.', industry_id: 10, location_id: 10 },
          ...
          { id: 101, company_id: 10, title: 'Jr Dev', level: 0, description: 'Looking for Jr Dev.', industry_id: 1, location_id: 1 },
          { id: 102, company_id: 10, title: 'Jr Dev', level: 0, description: 'Looking for Jr Dev.', industry_id: 2, location_id: 2 },
          { id: 103, company_id: 10, title: 'Jr Dev', level: 0, description: 'Looking for Jr Dev.', industry_id: 3, location_id: 3 },
          { id: 105, company_id: 10, title: 'Jr Dev', level: 0, description: 'Looking for Jr Dev.', industry_id: 4, location_id: 4 },
          { id: 106, company_id: 10, title: 'Mid Dev', level: 1, description: 'Looking for Mid Dev.', industry_id: 5, location_id: 5 },
          { id: 107, company_id: 10, title: 'Mid Dev', level: 1, description: 'Looking for Mid Dev.', industry_id: 6, location_id: 6 },
          { id: 108, company_id: 10, title: 'Mid Dev', level: 1, description: 'Looking for Mid Dev.', industry_id: 7, location_id: 7 },
          { id: 109, company_id: 10, title: 'Sr Dev', level: 2, description: 'Looking for Sr Dev.', industry_id: 8, location_id: 8 },
          { id: 110, company_id: 10, title: 'Sr Dev', level: 2, description: 'Looking for Sr Dev.', industry_id: 9, location_id: 9 },
